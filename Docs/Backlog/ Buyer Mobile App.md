...
* iOS (Kotlin Multiplatform – Build Cross-Platform Apps / React Native)
* Android (Kotlin Multiplatform – Build Cross-Platform Apps / React Native)

Recommended Stack:

* Kotlin Multiplatform – Build Cross-Platform Apps (preferred for speed + UI consistency)
* Riverpod / Bloc
* Socket.io client
* REST API Gateway
* Firebase (FCM)
...
Setup Kotlin Multiplatform – Build Cross-Platform Apps project with scalable architecture.
