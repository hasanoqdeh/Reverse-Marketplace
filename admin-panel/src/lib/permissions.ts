...
const ALLOWED_ROUTES: Record<string, string[]> = {
  SUPER_ADMIN: ['/admin/dashboard', '/admin/users', '/admin/logs', '/admin/settings', '/admin/profile'],
  ADMIN:       ['/admin/dashboard', '/admin/users', '/admin/logs', '/admin/settings', '/admin/profile'],
  SUPPORT:     ['/admin/dashboard', '/admin/users', '/admin/settings', '/admin/profile'],
}
